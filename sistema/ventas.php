...
<body>
    ...
    <section id="container">
        ...
        <a href="nueva_venta.php" class="btn_new" style="background-color: #1E30A0;"><i class="fa-solid fa-circle-plus"
                style="color: #ffff;"></i> Nueva
            Venta</a>

        <form action="buscar_venta.php" method="get" class="form_search">
            <input class="input_b" type="text" name="busqueda" id="busqueda" placeholder="No. Factura" />
        ...
        <div class="form_container">
            <form action="buscar_venta.php" method="get" class="form_search_date">
                <label>De:</label>
                <input type="date" name="fecha_de" id="fecha_de" require style="display: inline-block;">
                <label>A:</label>
                <input type="date" name="fecha_a" id="fecha_a" require style="display: inline-block;">
        ...
        <table>
            ...
            $query_paginador = mysqli_query($conection, "SELECT count(*) as total_registro FROM factura where estatus != 10");
            ...
            if ($result > 0) {
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    <tr id="row_<?php echo $data['nofactura']; ?>">
                        ...
                        <td class="textright totalfactura"><span></span>
                            <?php echo "$." . $data['totalfactura']; ?>
                        </td>
                        <td>
